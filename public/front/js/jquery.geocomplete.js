...
(function($, window, document, undefined){
  ...
  $.extend(GeoComplete.prototype, {
    ...
    initMarker: function(){
      if (!this.map){ return; }
      var options = $.extend(this.options.markerOptions, { map: this.map,icon:'http://dev.nsglobalsystem.com/mydayjob/public/assets/img/map_icon.png'});
