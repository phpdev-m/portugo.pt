...
<body>
  ...
  <div class=" inner_wrapper" style="margin-top:103px; padding-bottom:0px;">
   <div class="inmer_main">
      <div class="container">
      <div class="col-md-12">
       <a href="<?php echo base_url('home'); ?>"><?php echo $this->lang->line('Home');?></a>&nbsp;  / &nbsp; <?php echo $this->lang->line('Contact us');?>
      </div>
      </div>
   </div>
  <div class="container">
    ...
    <div class="col-md-12">
     <div class="message_head">
      <h1 style="margin-top:40px;"><a href="javascript:void(0)" style="color:#e81d25" class="mess_btn"><?php echo $this->lang->line('Contact us');?></a></h1>
     </div>
     ...
     <form id="registerForm" class="form-horizontal" name="register-form" method="post" action="<?php echo base_url('page/contact_us'); ?>">
...
<span id="first_name_error" style="display:none;color:#a94442;">*<?php echo $this->lang->line('Enter your First name');?>.</span>
</div>
</div>
...
<span id="last_name_error" style="display:none;color:#a94442;">*<?php echo $this->lang->line('Enter your Last name');?>.</span>
</div>
</div>
...
<span id="email_mag_error" style="display:none;color:#a94442;">*<?php echo $this->lang->line('is Invalid');?>.</span>
</div>
</div>
...
<button class="btn_login pull-right message_send" type="submit" style="padding:10px 0px; width:140px; font-size:16px;margin: 0px 0 40px;" onclick="return validate();"><?php echo $this->lang->line('Send Message');?></button>
...
<div class="modal fade" id="send_msg" tabindex="-1" role="dialog" >
  <div class="modal-dialog2" role="document">
   <div class="modal-body ">
      ...
      <center><h2> <?php echo $this->lang->line('Thank you for contacting us');?>!</h2> </center>
      <center><h4 style="margin:20px 0px 40px 0px"> <?php echo $this->lang->line('We will get back to you shortly');?></h4></center> 
       </div>
