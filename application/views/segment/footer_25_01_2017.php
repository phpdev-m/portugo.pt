 <div class="clearfix bar" id="malik" style="height:60px;">&nbsp;</div>
...
.res_top_nav { margin: 12px 0px 0px 0px; padding: 0; }
.res_top_nav a { color: #4d4d4d !important;  font-size: 14px; line-height:20px; display:inline;  list-style: none outside none; margin: 0; padding:7px 6px 10px; text-decoration: none;  font-family: 'Segoe UI'; font-weight:bold; text-align: center;}
...
<div style="background:#efeeee; overflow:hidden ">
 ...
 <div class=" pc footer_center">
  <div class="res_top_nav">
    ...
    <a href="<?php echo base_url('page/recomend_restaurant'); ?>"><?php echo $this->lang->line('Recommend a restaurant');?></a></li>
    <a href="<?php echo base_url('page/about_us'); ?>"><?php echo $this->lang->line('About Us');?></a></li>
 ...
 <div class="footer_bottom_right mobile mobile_footer" style="display:none;" >
