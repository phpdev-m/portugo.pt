<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="murilozs_api1.live.ie";
	$API_Password="SK5XWJR3B5QVK3EN";
	$API_Signature="AQU0e5vuZCvSg-XJploSa.sGUDlpA3WkF5mB9he2XWRgAh3Y35OxWvrk";
	...
	*/
	...
	if ($SandboxFlag == true) 
	{
echo '<script type="text/javascript"> alert("'. "sandbox" . '")</script>';
	...
	{
echo '<script type="text/javascript"> alert("'. "paypal" . '")</script>';
