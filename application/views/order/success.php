...
?> 
  ...
  <div class="container">
    <div class="row">
     ...
     <div class="thanks" >
     <h1><?php echo $this->lang->line('Thank_Order');?></h1>
     <p><img src="<?php echo base_url();?>public/front/images/tick.png"  /></p>
     <h4><?php echo $this->lang->line('Reference_Number');?> &nbsp;&nbsp;<?php if(@$session_order_data['order_id']) {echo @$session_order_data['order_id'];}?></h4>
     <h4><?php echo $this->lang->line('Order_Success');?></h4>
     <h4><?php echo $this->lang->line('Order_Success_Msg');?></h4>
     </div>
