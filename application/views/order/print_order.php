...
<div style="width:795px; margin:0px auto;">
 ...
 <tr>
  ...
  <tr>
    <td width="5%" height="40">&nbsp;</td>
    <td width="91%" height="40" align="center"  style=" font-family:Myriad Pro,arial; font-size:24px; color:#000000; "> <?php if($order['order_date']!=''){ echo date('d-m-Y',$order['order_date']); ?> <?php echo date('H:i A',$order['order_date']);} ?></td>
    <td width="4%" height="40" bgcolor="#FFFFFF">&nbsp;</td>
  </tr>
...
//echo '<script type="text/javascript"> alert("'. $delivery_charge . '")</script>';

$restaurante = $this->restaurant_model->get_restaurent_detail($order['restaurant_id']);
