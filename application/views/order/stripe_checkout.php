...
<form name="stripeform" id="stripeform" action="<?php echo base_url('application/views/order/stripe_payment.php');?>" method="POST">
<input type="hidden" name="final_amount" id="final_amount" value="<?php echo $this->session->userdata('final_amount'); ?>">
<input type="hidden" name="order_number" id="order_number" value="<?php echo @$session_order_data['order_id']; ?>">
<script
