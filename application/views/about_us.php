...
<body>
  ...
  <?php $this->load->view('segment/header');?> 	 
   ...
   <div class="inmer_main">
      <div class="container">
      <div class="col-md-12">
       <a href="#"><?php echo $this->lang->line('Home');?></a>&nbsp;  / &nbsp; <?php echo $this->lang->line('About Us');?>
      </div>
      </div>
   </div>
  <div class="container">
    ...
    <div class="col-md-12">
     ...
     <?php 
	 $cms_data=$this->home_model->get_aboutus_cms(); 
	 ?>
	 ...
	 <?php }else{ ?>
      <h1><?php echo $cms_data['portugoese_tittle']; ?></h1>
       ...
       <p style="background-color:white !important;"><?php echo stripslashes($cms_data['portugoese_content']);?></p>
