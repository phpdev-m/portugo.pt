...
<?php $this->load->view('segment/header');?>
  ...
  <div class=" inner_wrapper wrap_margin" >
   <div class="inmer_main">
      ...
      <div class="col-md-12 padding_main">
       <a href="#"><?php echo $this->lang->line('Home');?></a>&nbsp;  / &nbsp;       <?php echo $this->lang->line('My Favorite Restaurants');?>
      </div>
      </div>
   </div>
  <div class="container">
    ...
    <h1><?php echo $this->lang->line('My Favorite Restaurants');?></h1>
    </div>
    <div>
  ...
  <tr>
    ...
    <td width="30%" height="40" align="center" class="td_bord2"><strong><?php echo $this->lang->line('Reviews');?></strong></td>
  ...
  {	 
  foreach($fav_restaurant as $allrestaurant)
  {	  
  $restaurant=$this->restaurant_model->get_restaurent_detail($allrestaurant['restaurant_id']);
  //print_r($restaurant);
  $i++;
  ?>
  
   <tr id="row<?php echo $allrestaurant['fav_id']; ?>">
    
    <td height="60" align="center" class="td_bord2"><a href="#"> <?php echo ucfirst($restaurant['restaurant_name']); ?></a> </td>
    <td height="60" align="center" class="td_bord2"><a href="#"><?php if($restaurant['avg_rating']!='')
	{echo '<h4 style="color:#ffbf00;">'; 
	
	for($j=1;$j<=$restaurant['avg_rating']; $j++)
	{
   echo '<i class="fa fa-star"></i>';
    }
    
	for($j=1;$j<=5-$restaurant['avg_rating']; $j++)
	{
   echo  '<i class="fa fa-star-o"></i>';
     } 
	echo ' </h4>';
	}?></a></td>
    <td height="60" align="center" class="td_bord2"><a href="javascript:void(0);" data-target="#myModal_res_detail" data-toggle="modal" class="remove" id="remove<?php echo $allrestaurant['fav_id']; ?>"><img src="<?php echo base_url();?>public/front/images/delete.png"  /></a></td>
   </tr>
      ...
      <div class="modal-body " id="model_content">
       <form  class="form-horizontal san" name="register-form" >
        ...
        <div class="form-group has-feedback">
          ...
          <h4 style="text-align:center"><?php echo $this->lang->line('Are you  sure to  remove this restaurant from your  favourite list');?></h4>
...
<input type="hidden" name="" id="rest_id">
<script>
$(document).ready(function(){
...
var res=$(this).attr('id');
var fav_id=$("#rest_id").val();
$.ajax({ 
    type: "POST",
    url: '<?php echo base_url('restaurant_details/remove_fav'); ?>', 
    data: {fav_id:fav_id}, 
