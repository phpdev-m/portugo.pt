...
<h3 class="page-title">
<?php echo $this->lang->line('Rest_Add_Cuisine'); ?>
</h3>
<ul class="breadcrumb">
<li>
<i class="icon-home"></i>
...
<li><a href="<?php echo base_url('restaurant/cuisine/mamage_cuisine'); ?>"><?php echo $this->lang->line('Rest_Manage_Cuisine'); ?></a>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo $this->lang->line('Rest_Add_Cuisine'); ?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url('restaurant/cuisine/add_cuisine') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label"><?php echo $this->lang->line('Rest_Cuisine_Name'); ?><span class="required">*</span></label>
										<div class="controls">
											<input id="cuisin_name" class="m-wrap span4" value="" type="text" name="cuisin_name[]"/>&nbsp;&nbsp;(English)
										</div>
									</div>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" id="add_more" style="margin-top:20px; margin-left:470px; color:#069;"><strong><?php echo $this->lang->line('Rest_Add_More'); ?></strong></a>
									...
									<div class="control-group">
										<label class="control-label"><?php echo $this->lang->line('Rest_Cuisine_Name'); ?><span class="required">*</span></label>
										<div class="controls">
											<input id="portu_cuisin_name" class="m-wrap span4" value="" type="text" name="portu_cuisin_name[]"/>&nbsp;&nbsp;(Portugal)
										</div>
									</div>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" id="add_moree" style="margin-top:20px; margin-left:470px; color:#069;"><strong><?php echo $this->lang->line('Rest_Add_More'); ?></strong></a>
                                    
                                    
                                    
                                    
                                    <div class="control-group" style="display:none;">
                                    <label class="control-label"><?php echo $this->lang->line('Rest_Description'); ?></label>
                                    <div class="controls">
 ...
 <?php 
  ...
  ?>
									...
									<div class="form-actions">
                                      ...
                                      <input type="submit" name="submit" class="btn green" value="<?php echo $this->lang->line('Rest_ADD'); ?>">&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('restaurant/cuisine/mamage_cuisine'); ?>"><button type="button" class="btn green" id="adcms"><?php echo $this->lang->line('Rest_CANCEL'); ?></button></a>
...
var res='<div id="rowNum'+rowNum+'"><div class="control-group"><label class="control-label"><?php echo $this->lang->line('Rest_Cuisine_Name'); ?><span class="required">*</span></label><div class="controls"><input id="cuisin_name" class="m-wrap span4" value="" type="text"name="cuisin_name[]"/>&nbsp;&nbsp;(English)<a href="javascript:void(0);" onClick="removeRow('+rowNum+');" style="margin-top:20px; margin-left:10px;color:#069;"><strong>Remove</strong></a></div></div></div>';
...
<script>
$(document).ready(function(){
$("#add_moree").click(function(){	
	var rowNum = 0;
	rowNum ++;
	//alert('hiiii');return false;
var res='<div id="rowNum'+rowNum+'"><div class="control-group"><label class="control-label"><?php echo $this->lang->line('Rest_Cuisine_Name'); ?><span class="required">*</span></label><div class="controls"><input id="portu_cuisin_name" class="m-wrap span4" value="" type="text"name="portu_cuisin_name[]"/>&nbsp;&nbsp;(Portugal)<a href="javascript:void(0);" onClick="removeRow('+rowNum+');" style="margin-top:20px; margin-left:10px;color:#069;"><strong>Remove</strong></a></div></div></div>';
$("#show_moree").append(res);
});
});
