...
<li><a href="<?php echo base_url('restaurant/cuisine/mamage_cuisine'); ?>">Manage Cuisine</a>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-body form">
                                                          <form action="<?php if(!empty($rest_id)){echo base_url('restaurant/cuisine/edit_cuisine/id/'.$id.'/'.$rest_id);}else{echo base_url('restaurant/cuisine/edit_cuisine/id/'.$id);}?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="cuisin_name" class="m-wrap span4" type="text" value="<?php echo $edit_cuisine['cuisine_name'];?>" name="cuisin_name"/>
										</div>
									</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('restaurant/cuisine/mamage_cuisine'); ?>"><button type="button" class="btn green" id="adcms">CANCEL</button></a>
