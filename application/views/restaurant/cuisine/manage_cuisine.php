				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('restaurant/cuisine/mamage_cuisine'); ?>">Manage Cuisine</a>
								<i class="icon-angle-right"></i>
						...
						<div class="portlet box red">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php if(!empty($rest_id)){echo base_url('restaurant/cuisine/add_cuisine/'.$rest_id);}else{echo base_url('restaurant/cuisine/add_cuisine');}?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<td><?php echo $sn;?></td>
											...
											<td class="center">
		                                    <?php if($cuisine_all['status']==0){ echo "Inactive";} if($cuisine_all['status']==1){echo "Active";}?>
                                            </td>											
                                            
                                            
               <td><center><a href="<?php if(!empty($rest_id)){echo base_url("restaurant/cuisine/edit_cuisine/id/".$cuisine_all['id']."/".$rest_id); }else{echo base_url("restaurant/cuisine/edit_cuisine/id/".$cuisine_all['id']);} ?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i>
</a>&nbsp;&nbsp;
											<a href="<?php echo base_url("restaurant/cuisine/delete_cuisine/id/".$cuisine_all['id']."/".$rest_id);?>" onClick="return confirm('Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
</center></td>                             
