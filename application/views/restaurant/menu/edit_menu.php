					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit Item</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                   <form action="<?php echo base_url('restaurant/category_menu/edit_menu/'.$item_id.''); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           <input type="hidden" name="file_hidden" value="<?php echo $items_data['item_image'];?>">
                                        ...
                                        <?php
										$menu_type=array();
										$menu_type=explode(',',$items_data['allergens']);
										?>
										...
										<div class="controls">                                        
											<input type="checkbox" name="menu_type[]" value="Meat" <?php if(in_array('Meat',$menu_type)){echo "checked"; }?> > <?php echo $this->lang->line('Rest_Meat'); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" name="menu_type[]" value="Vegan" <?php if(in_array('Vegan',$menu_type)){echo "checked"; }?>> <?php echo $this->lang->line('Rest_Vegan'); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" name="menu_type[]" value="Vegetarian" <?php if(in_array('Vegetarian',$menu_type)){echo "checked"; }?>> <?php echo $this->lang->line('Rest_Vegetarian'); ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" name="menu_type[]" value="Gluten Free" <?php if(in_array('Gluten Free',$menu_type)){echo "checked"; }?>> <?php echo $this->lang->line('Rest_Gluten_Free'); ?>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" name="menu_type[]" value="Dairy Free" <?php if(in_array('Dairy Free',$menu_type)){echo "checked"; }?>> <?php echo $this->lang->line('Rest_Dairy_Free'); ?> 
                                        ...
                                        <div class="control-group" style="display:none;">                                        
										<label class="control-label"><?php echo $this->lang->line('Rest_Add-ons'); ?><span class="required">*</span></label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group" style="display:none;">
                                        ...
                                        <input class="m-wrap span1" name="currency" value="€" style="width:50px;" />
											<select class="m-wrap span1" name="ctype[]" style="width:100px;">							
											<option value="Euro" <?php if($items['type']=='Euro'){echo "selected"; }?>>€</option>											
											</select>&nbsp;&nbsp;<input id="pricee" class="m-wrap span2" value="<?php echo $items['price']; ?>" type="text" name="pricee[]" style="width:170px;"/>
                                            
                                            &nbsp;&nbsp;<a href="<?php echo base_url("restaurant/category_menu/delete_extra_menu/".$item_id."/id/".$rest_id."/".$items['id']); ?>" onClick="return confirm('Sure you want to delete this?');" style="margin-top:20px; margin-left:10px;"><strong>Delete</strong></a>
                                        ...
                                        <a href="javascript:void(0)" id="add_more" style="margin-top:20px; margin-left:470px; display:none;"><strong>Add More</strong></a>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											...
											<option <?php if($items_data['status']==1){echo 'selected="selected"';}?> value="1"><?php  echo  $this->lang->line('Active'); ?></option>
											<option <?php if($items_data['status']==0){echo 'selected="selected"';}?> value="0"><?php  echo  $this->lang->line('Inactive'); ?></option>
											</select>
										</div>
									    </div>
                                 ...
                                 &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php if(!empty($rest_id)){echo base_url('restaurant/category_menu/manage_menu/'.$rest_id); }else {echo base_url('restaurant/category_menu/manage_menu');} ?>"><button type="button" class="btn green" id="adcms"><?php echo $this->lang->line('Rest_CANCEL'); ?></label></button></a>
...
var res='<div class="controls"><input id="exta_items" class="m-wrap span4" value="" type="text" name="extra_items1[]" style="margin-top:20px;"/></div><div class="controls"><select class="m-wrap span1" name="ctype1[]" style="width:100px; margin-top:20px;"><option value="Euro">€</option><option value="Pound">£</option><option value="Yen">¥</option></select>&nbsp;&nbsp;<input id="pricee" class="m-wrap span2" value="" type="text" name="pricee1[]" style="width:170px; margin-top:20px;"/></div>';
