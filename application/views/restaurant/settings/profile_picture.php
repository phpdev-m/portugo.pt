								...
								<div>
									<div class="portlet box red ">
										...
										<div class="portlet-body form">
											...
											<form action="<?php echo base_url('restaurant/settings/profile_pricture'); ?>" class="form-horizontal form-bordered form-label-stripped" method="post" id="form1" name="form1" enctype="multipart/form-data">
												<div class="control-group">
													...
													<div class="controls">
														...
														<br>
														<?php if($restaurant['profile_picture']!='' && file_exists('public/restaurant/restaurant_image/'.$restaurant['profile_picture'])){?> <img src="<?php echo base_url('public/restaurant/restaurant_image/'.$restaurant['profile_picture']); ?>" height="150" width="150" ><?php } ?>
													</div>
												</div>
