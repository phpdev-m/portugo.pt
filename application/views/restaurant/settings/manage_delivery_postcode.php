			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							<?php echo $this->lang->line('Rest_Manage_Order_Delivery_Postcode'); ?>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li>
								<a href="<?php echo base_url('restaurant/settings/delivery_postcode'); ?>"><?php echo $this->lang->line('Rest_Manage_Order_Delivery_Postcode'); ?></a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i><?php echo $this->lang->line('Rest_Manage_Order_Delivery_Postcode'); ?></div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php if(!empty($rest_id)){echo base_url('restaurant/settings/add_postcode/'.$rest_id);}else{echo base_url('restaurant/settings/add_postcode');}?>">
										...
										<div class="btn-group">
			                  <a href="<?php if(!empty($rest_id)){echo base_url('restaurant/settings/add_postcode_multi/'.$rest_id);}else{echo base_url('restaurant/settings/add_postcode_multi');}?>">
                                                                                <button class="btn green">
                                                                                <?php echo $this->lang->line('Rest_Add_new').'(AutoCode)' ;  ?> <i class="icon-plus"></i>
                                                                                </button>
                                                                                    </a>
                                                                        </div>
								</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<thead>
										<tr>
										<th>Sl No.</th>
											<th><?php echo $this->lang->line('Rest_Postcode'); ?></th>
									...
									<tbody>
										<?php 
										$sn=1;
										foreach($postcode as $all_postcode){
										//print_r($w); die;
										...
										<tr>
										<td><?php echo $sn;?></td>
											<td><?php echo $all_postcode['deliver_postcode'];?></td>
