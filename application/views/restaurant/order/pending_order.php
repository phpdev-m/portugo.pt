				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('restaurant/order/pending_order'); ?>">Pending Orders</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Pending Orders</div>
								<div class="tools">
                            ...
                            <form  action="<?=base_url()?>restaurant/order" method="POST">	
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
			                            ...
			                            <td><?php if($w['delivery_time']!=''){ echo $w['delivery_time'];} ?></td> 
										 <!--<td><?php if($w['user_type']==1){echo 'Registered User';}else{echo 'Guest';}?></td> -->
										...
										<td><center><a href="<?php echo base_url("restaurant/order/pending_order_edit/id/".$w['id']);?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i>
                                        <a href="<?php echo base_url("restaurant/order/pending_order_view/id/".$w['id']);?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>
                                        </a>
										
										<a href="<?php echo base_url("restaurant/order/pending_delete_order/id/".$w['id']);?>" onClick="return confirm('Are You Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
                                        </center></td>
										</tr>
									<?php }//$sn++;} ?>	
									</tbody>
