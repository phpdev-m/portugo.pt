								...
								<table class="table1">
									...
									<tbody>
										<tr>
											...
											<tr> <td>Order Date </td> <td>:<?php if($order['order_date']!=''){echo date('d-m-Y',$order['order_date']);}?></td></tr>
								...
								<table class="table1" id="">
									...
									<tbody>
										<tr>
										    ...
										    <tr> <td>Customer Name </td> <td>: <?php $customer = $this->order_model->get_guest_detail($order['guest_id']);
											
										    echo ucwords($customer['full_name']);?></td></tr>
											...
											echo $customer['address_line_1'].'&nbsp,'.$customer['address_line_1'].'&nbsp,'.'&nbsp,'.$customer['city'].'&nbsp,'.$customer['postcode'];
											
											?></td></tr>
								            <tr> <td>Customer Phone No </td> <td>: <?php echo $customer['phone_number'];?></td></tr>
