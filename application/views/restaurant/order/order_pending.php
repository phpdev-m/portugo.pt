			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							<?php echo $this->lang->line('Rest_Pending_Orders'); ?>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li>
								<a href="<?php echo base_url('restaurant/order/pending'); ?>"><?php echo $this->lang->line('Rest_Pending_Orders'); ?></a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i><?php echo $this->lang->line('Rest_Pending_Orders'); ?></div>
								<div class="tools">
                            ...
                            <form  action="<?=base_url()?>restaurant/order/pending" method="POST">	
