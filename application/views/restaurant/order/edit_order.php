...
<h3 class="page-title">
<?php echo $this->lang->line('Edit_Order');?>
</h3>
<ul class="breadcrumb">
<li>
<i class="icon-home"></i>
...
<li><a href="<?php echo base_url('restaurant/order/all'); ?>">Manage Orders</a>
<i class="icon-angle-right"></i>
</ul>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo $this->lang->line('Edit_Order');?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                  <form action="<?php echo base_url("restaurant/order/order_edit/id/".$order['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label"><?php echo $this->lang->line('Status');?><span class="required">*</span></label>
										<div class="controls">
											<select class="m-wrap span4" name="status" id="status" required>
											<option value="">--Select Status--</option>
											
											<option <?php if($order['status']==0){echo 'selected="selected"';}?> value="0"><?php echo $this->lang->line('Cancelled');?></option>
											<option <?php if($order['status']==1){echo 'selected="selected"';}?> value="1"><?php echo $this->lang->line('Pending');?></option>
											<option <?php if($order['status']==2){echo 'selected="selected"';}?> value="2"><?php echo $this->lang->line('Processing');?></option>
                                            <option <?php if($order['status']==3){echo 'selected="selected"';}?> value="3"><?php echo $this->lang->line('Delivered');?></option>
											</select>
										</div>
									    </div> 
										
										<div class="control-group" style="display:<?php if($order['status']!=0){echo 'none';} ?>;" id="reason_div">
													<label class="control-label"><?php echo $this->lang->line('Reason');?></label>
													<div class="controls">
														<textarea id="cancel_reason" name="cancel_reason" class="m-wrap span4"><?php echo $order['cancel_reason']; ?></textarea>
                                    ...
                                    <input type="submit" name="submit" id="update" class="btn green" value="<?php echo $this->lang->line('Update');?>">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('restaurant/order/all'); ?>"><button type="button" class="btn green" id="adcms"><?php echo $this->lang->line('Cancel');?></button></a>
