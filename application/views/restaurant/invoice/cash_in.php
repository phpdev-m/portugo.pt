			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							<?php echo $this->lang->line('Rest_Cash_In');?>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i><?php echo $this->lang->line('Rest_Cash_In');?></div>
								<div class="tools">
                  ...
                  <a href="javascript:void(0);" id="create_invoice">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<thead>
										...
										<th><?php echo $this->lang->line('Rest_Payment_Through_Website_Total');?></th>
										<th><?php echo $this->lang->line('Rest_Commission');?>(%) </th>
										<th><?php echo $this->lang->line('Rest_Total_Commission');?> </th>
										<th><?php echo $this->lang->line('Rest_Balance');?> </th>
									...
									<td class="center">
										...
										<td><?php echo $dollar;?><?php
										$balance=$w['total_amount']- $commission;
