...
<!-------- Google Find Zip Code--------->
<!--<script type="text/javascript" src="<?php //echo base_url();?>public/front/js/jquery-1.10.2.js"></script>-->
  ...
  <form id="registerForm" action="<?php echo base_url('search'); ?>" method="post" class="form-horizontal bv-form" name="register-form" role="form">
     ...
     <div id="custom-search-input">
							...
							<p style="position: absolute; border: 1px solid rgb(255, 0, 0); background-color: rgb(255, 0, 0); color: rgb(255, 255, 255); padding: 10px; margin-top: -50px; border-radius: 5px; display:none;" id="city_error"><i class="fa fa-caret-down" aria-hidden="true" style="font-size:18px; padding-top:23px; color:#FF0000; position:absolute;"></i><?php echo $this->lang->line('Please find your location');?></p>
                              <input type="text" name="search" id="geocomplete" class="banner_input clearable address " autocomplete="off" value="<?php echo $session_user_id['search_data'];?>" placeholder="e.g. SW6 6LG" data-masked-input="9999-999" maxlength="8"/>
                                <span class="input-group-btn  anil search-data" style="cursor:pointer">
                                    <button class="btn btn-danger" type="button">
                                        <span class=" glyphicon glyphicon-search "></span>
                                    </button>
                                </span>
								<!--<span class="input-group-btn  anil" style="cursor:pointer">
                                    <button class="btn btn-danger" type="button">
                                        <span class=" glyphicon glyphicon-search "></span>
                                    </button>
                                </span>-->
     ...
     <center><button type="button" name="submit"  id="check" onclick="showlocation();" class="find_btn find-me check" style="display:;"><?php echo $this->lang->line('FIND ME');?>  <i  ><img src="<?php echo base_url();?>public/front/images/find_icon.png" style="margin:-5px 0px 0px 15px" /></i></button></center>
	 <center><button type="button" name="submit"  id="check" onclick="showlocation();" class="find_btn find-me blink" style="display:none;"><?php echo $this->lang->line('FIND ME');?>  <i  ><img src="<?php echo base_url();?>public/front/images/find_icon.png" style="margin:-5px 0px 0px 15px" /></i></button></center>
...
<div class="form-group">
  <div class="col-md-12 padding">
   ...
   <input type="button" class="btn_login alo search-data"  value="Confirm" style="margin:5px 0px 0px 0px; float:right;"/>
 ...
 <script type="text/javascript">
      ...
      function callback(position) {
        ...
        var lon = position.coords.longitude; 
		 var geocomplete = geoplugin_countryName();
		...
		$.ajax({
						type:"GET",
						url:"http://maps.googleapis.com/maps/api/geocode/xml?latlng="+lat+","+lon+"&sensor=true",
						cache: false,
						dataType: "xml",
                ...
                $(xml).find('address_component').each(function(){
                    ...
                    $(this).find("long_name").each(function(){
                        var name = $(this).text();
						 $('#geocomplete').val(name); 
						  $('#showtext').html(name+" "+zone+" "+geocomplete);
