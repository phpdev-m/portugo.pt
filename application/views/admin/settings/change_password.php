								...
								<div>
									<div class="portlet box red ">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Settings: Change Password</div>
											<div class="tools">
										...
										<div class="portlet-body form">
											...
											<form action="<?php echo base_url('admin/settings/change_password'); ?>" class="form-horizontal form-bordered form-label-stripped" method="post" id="form1" name="form1">
