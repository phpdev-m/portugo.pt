								...
								<div>
									<div class="portlet box red ">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Settings: Change Account</div>
											<div class="tools">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
                                             <div id="myDiv"><?php if(isset($error) && $error!=''){?><br /><div class="error" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?=$error?></div><?php } ?></div> 
                                          
                                            <? if($success!=''){?><div class="success" style="color:#0F0;"><? echo $success;?> </div> <? }?><br>
                                           
											<form action="<?php echo base_url('admin/settings/account'); ?>" class="form-horizontal form-bordered form-label-stripped" method="post" id="form1" name="form1">
												<div class="control-group" style="display:<?php if($veryfy==2){ echo 'none';}else{echo '';} ?>">
													<label class="control-label">Password</label>
													<div class="controls">
														<input type="password" placeholder="" class="m-wrap span12" name="password" />
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group" style="display:<?php if($veryfy==1){ echo 'none';}else{echo '';}  ?>">
													<label class="control-label">Email</label>
													<div class="controls">
														<input type="text" placeholder="medium" class="m-wrap span12" name="email" />
														<span class="help-inline"></span>
													</div>
												</div>
                                                ...
                                                <div class="control-group" style="display:<?php if($veryfy==1){ echo 'none';}else{echo '';}  ?>">
													...
													<div class="controls">
														<input type="text" placeholder="medium" class="m-wrap span12" name="username" />
														<span class="help-inline"></span>
													</div>
												</div>
