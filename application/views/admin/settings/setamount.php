...
<li><a href="#">Manage Minimum  Amount</a>
...
<div id="tab_1-1" class="tab-pane active">
                                   ...
                                   <div id="myDiv"><?php  if ($this->session->flashdata('message') != ''){?><br /><div class="success" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?php echo $this->session->flashdata('message');?></div><?php } ?></div>
...
<form action="<?php echo base_url('admin/settings/set_amount/'.$query['id']); ?>" method="post" enctype="multipart/form-data">
<label class="control-label">Amount($)</label>
<input type="text" class="m-wrap span8" name="amount" id="title" value="<?php echo $query['amount']; ?>" />
