				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/settings/payment'); ?>">Manage Payment Info</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Payment Info</div>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr>
										<td><?php echo $sn;?></td>
										<td><?php echo $w['payment_name'];?></td>
										<td>
                                        <select class="m-wrap span6 status" name="status" id="<?php echo $w['id'];?>">
                                            <option value="">Select Status</option>
                                            <option value="1" <?php if($w['status']==1){ echo "selected";} ?>>Active</option>
											<option value="0" <?php if($w['status']==0){ echo "selected";}?>>Inactive</option>
                                            </select>		                                
                                        </td>											
...
$(document).on('change','.status',function(){
 ...
 var status_data = $(this).val();
  var payment_id = $(this).attr('id'); 
	  ...
	  $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/payment/change_payment_status",
            data:{status_data:status_data,payment_id:payment_id}
		}).done(function(msg){
	//alert(msg);
