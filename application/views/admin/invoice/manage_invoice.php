...
<head>
	<meta charset="utf-8" />
	<title><?php echo $title;?> | Admin Panel | Manage Invoices</title>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/invoice'); ?>">Manage Invoices</a>
								<i class="icon-angle-right"></i>
                  ...
                  <a href="<?php echo base_url('admin/restaurant/add_restaurant');?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<thead>
                                        ...
                                        <th width="53">Month</th>
                                        <th width="220">Restaurant</th>
                                        <th width="226">Invoice Ac Balance</th>
						...
						$orders = $this->restaurant_model->get_restaurant_orders($invoice_data['restaurant_id']);
						$total_orders = count($orders);
						$i=0;
						foreach($orders as $all_orders){						
						$i=$all_orders['total_amount']+$i;						
						}																																										
						$payment_by_online = $this->restaurant_model->get_online_payment($invoice_data['restaurant_id']);
						...
						$commission_on_orders = ($i * $restaurant['commission'])/100;
                                        ...
                                        <td><center><?php echo number_format($commission_on_orders, 2, '.', ','); ?></center></td>
                                        ...
                                        <td><center><?php echo $invoice_data['id'];?></center></td>                                            
                                           ...
                                           <td><center><select class="m-wrap span4 status" width="width: 136px !important;" id="<?php echo $invoice_data['id'];?>" name="status" style="width:150px;">
											<option value="">Select</option>
											<option value="Invoice Sent" <?php if($invoice_data['status']=='Invoice Sent'){echo "selected"; }?>>Invoice Sent</option>
											<option value="Payment Sent" <?php if($invoice_data['status']=='Payment Sent'){echo "selected"; }?>>Payment Sent</option>
                                            <option value="Payment Receive" <?php if($invoice_data['status']=='Payment Receive'){echo "selected"; }?>>Payment Received</option>                                            
                                             
											</select></center></td>
                                            
											<td><center><a href="<?php echo base_url();?>admin/invoice/invoice_view/id/<?php echo $invoice_data['id'];?>/<?php echo $restaurant['id']; ?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i>
                                        </a>
										&nbsp;&nbsp;
