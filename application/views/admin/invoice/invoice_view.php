			...
			<div style="display:block; width:100%; vertical-align:top;">
				...
				<div style="display:inline-block; width:100%; padding-bottom:20px;">
					<div style="display:inline-block; width:49%; vertical-align:top;">
						...
						<div style="display:inline-block; width:100%; vertical-align:top; padding-bottom:5px;">Period : (<?php echo date('d M Y',strtotime($invoice['invoice_date'])); ?>)</div>
					</div>
					<div style="display:inline-block; width:49%; vertical-align:top; float:right;">					
					
                    <img src="<?php echo base_url(); ?>public/images/logo.png" alt="Logo" width="40%" title="Go Takeway" style="float:right;">
				...
				<div style="display:inline-block; width:100%; border-top:1px solid #000; padding-top:20px;">
					...
					<div style="display:inline-block; width:49%; vertical-align:top; float:right; text-align:right;">
						...
						<div style="display:block; width:100%;">
							<!--<div style="display:inline-block; padding-right:20px; vertical-align:top;font-weight:bold;">Email :</div>-->
							<div style="display:inline-block; vertical-align:top;"><span style="font-weight:bold">Email : </span><a href="http://www.comeneat.com/v2/admincp/support@roamsoft.in"><?php echo $restaurant['contact_email']; ?></a></div>
						</div>
						<div style="display:block; width:100%;">
			...
			<div style="display:block; width:100%; vertical-align:top; margin-top:15px;margin-bottom:10px;">
				...
				<table width="100%" align="center" style="font:13px Arial;">
                    ...
                    <tr>
						...
						<td width="15%" style="padding-bottom:5px; padding-left:5px; padding-right:5px; padding-top:5px; text-align:right; border-bottom:1px solid #ddd9c3;"><?php echo $dollar; ?> <?php echo number_format($payable_invoice, 2, '.', ','); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="15%" style="padding-bottom:5px; padding-left:5px; padding-right:5px; padding-top:5px; text-align:right; border-top:1px solid #ddd9c3; font-weight:bold;"><?php echo $dollar; ?> <?php echo number_format($commission_on_orders, 2, '.', ','); ?></td>
					</tr>
				</tbody></table>
			</div>
