				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/invoice');?>">Manage Invoice</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div>
							...
							<div class="portlet-body">
								...
								<?php /*?><table  class="table table-striped table-hover table-bordered" >
				...
				<div class="row-fluid" style="width:950px;">
					<div class="span12">
						...
						<div >
							...
							<?php /*?><div class="portlet-body" style="margin-top:20px;">
                            
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left"><table class="table1">
    ...
    <td align="right"><table class="table1">
								...
								<?php /*?><table class="table1" id="">
									...
									<tbody>
										<tr>
                                            ...
                                            <tr> <td>Customer Mobile Number </td> <td>: <?php echo $customer['mobile'];?></td></tr>
								...
								<table class="table1" id="">
									...
									<tbody>
										<tr>
											...
											?>
										    <tr><td>Payment Method </td> <td>: <?php echo ucfirst($payment['transaction_mode']);?></td></tr>
