...
<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">						     
						<h3 class="page-title">Edit language
</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">                            
								<div class="caption"><i class="icon-reorder"></i>Edit language</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                            <form action="<?php echo base_url('admin/language/edit/'.$this->uri->segment(4));?>" enctype="multipart/form-data" id="category" class="form-horizontal formcms" method="post">
									...
									<div class="alert alert-success">
										...
										<div class="controls">
											<input id="country" type="text" name="country" data-required="1" required class="span6  " value="<?php echo $lang_detail['country']; ?>"/>
										</div>
									</div>      
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
							<input id="lang_code" type="text" name="lang_name" data-required="1" required class="span6  " value="<?php echo $lang_detail['lang_name']; ?>"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
							<input id="lang_code" type="text" name="lang_code" data-required="1" required class="span6  " value="<?php echo $lang_detail['lang_code']; ?>"/>
										</div>
									</div>      
									
									<input type="hidden" name="old_lang_code" value="<?php echo $lang_detail['lang_code'];?>">
...
<div style="clear:both"></div>
									...
									<div class="form-actions">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/language'); ?>"><button type="button" name="submit" class="btn green"/>CANCEL</button></a>
									</div>
								</form>
								<!-- END FORM-->
							</div>
