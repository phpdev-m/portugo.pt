				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php if(!empty($rest_id)){echo base_url('admin/category_menu/manage_menu/'.$rest_id);}else {echo base_url('admin/category_menu/manage_menu');} ?>">Manage Menu</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Menu</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php if(!empty($rest_id)){echo base_url('admin/category_menu/add_menu/'.$rest_id); }else{echo base_url('admin/category_menu/add_menu');} ?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<thead>
										...
										<th width="33">Sl No.</th>
											<th width="95">Dish Name</th>
                                            <th width="43">Type</th>
                                            <th width="71">Category</th>
											<th width="39">Price</th>                                            
					                        <th width="68">Status</th>											
											<th width="76"><center>Action</center></th>
									...
									<tbody>
										...
										<td><?php echo $sn;?></td>
                                            ...
                                            <td>€<?php echo $menu_all['item_cost'];?></td>                                            
											<td class="center">
		                                    <?php if($menu_all['status']==0){ echo "Inactive";} if($menu_all['status']==1){echo "Active";}?>
                                            </td>
											
                                            
                                            <td><center><a href="<?php if(!empty($rest_id)){echo base_url("admin/category_menu/edit_menu/".$menu_all['id']."/id/".$rest_id); }else {echo base_url("admin/category_menu/edit_menu/".$menu_all['id']);} ?>"><i class="icon-large icon-edit" style="font-size:20px;"></i>
</a>&nbsp;&nbsp;
  <a href="<?php echo base_url("admin/category_menu/view/id/".$menu_all['id']);?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>
  &nbsp;&nbsp;
  
											<a href="<?php if(!empty($rest_id)){echo base_url("admin/category_menu/delete_menu/id/".$menu_all['id']."/".$rest_id); }else {echo base_url("admin/category_menu/delete_menu/id/".$menu_all['id']);} ?>" onClick="return confirm('Sure you want to delete this?');"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
</center></td>
