					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Add Cuisine</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php if(!empty($rest_id)){echo base_url('admin/cuisine/add_cuisine/'.$rest_id); }else{echo base_url('admin/cuisine/add_cuisine');} ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="cuisin_name" class="m-wrap span4" value="<?php echo $this->input->post('cat_name');?>" type="text" name="cuisin_name"/>&nbsp;&nbsp;&nbsp;(English)
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										<label class="control-label">Cuisine Name<span class="required">*</span></label>
										<div class="controls">
											<input id="portu_cuisin_name" class="m-wrap span4" value="<?php echo $this->input->post('cat_name');?>" type="text" name="portu_cuisin_name"/>&nbsp;&nbsp;&nbsp;(Portugal)
										</div>
									</div>
 ...
 <?php 
  ...
  ?>
									...
									<div class="form-actions">
                                      ...
                                      <input type="submit" name="submit" class="btn green" value="ADD">&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/cuisine'); ?>"><button type="button" class="btn green" id="adcms">CANCEL</button></a>
