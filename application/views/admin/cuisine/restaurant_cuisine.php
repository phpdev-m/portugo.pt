...
<li><a href="<?php echo base_url('admin/cuisine/restaurant_cuisine/'.$this->uri->segment(4)); ?>">Manage Cuisine</a>
...
<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Cuisine</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url('admin/cuisine/restaurant_cuisine/'.$rest_id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label">Select cuisine<span class="required">*</span></label>
										<div class="controls">
        ...
        <?php } ?>                                
									...
									<div class="form-actions">
                                      ...
                                      <input type="submit" name="submit" class="btn green" value="SAVE">&nbsp;&nbsp;&nbsp;&nbsp;<!--<a href="javascript:void(0);" onclick="javascript:history.go(-1);"><button type="button" class="btn green" id="adcms">BACK</button></a>-->
