...
<head>
	<meta charset="utf-8" />
	<title><?php echo $title; ?> | Admin Panel | Login Page</title>
	...
	<link href="<?php echo base_url('public/admin/assets/css/pages/login.css') ; ?>" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="logo" style="background:#ffffff; width:321px;">
		<img src="<?php echo base_url('public/admin/assets/img/logo.png'); ?>" alt="Logo" width="180" />
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
         <?php echo form_open(base_url('admin/login/verify')); ?>
		<form class="form-vertical login-form" action="<?php echo base_url('admin/login/verify'); ?>" method="post">
			<h3 class="form-title" style="text-align:center">Welcome Back</h3>
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		<?php echo date('Y'); ?> &copy; <?php echo $title; ?> Admin Dashboard .
	</div>
	<!-- END COPYRIGHT -->
	...
	<script src="<?php echo base_url('public/admin/assets/plugins/jquery-validation/dist/jquery.validate.min.js'); ?>" type="text/javascript"></script>	
	...
	<script src="<?php echo base_url('public/admin/assets/scripts/login.js'); ?>" type="text/javascript"></script> 
