				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/restaurant/manage_restaurant'); ?>">Manage Restaurants</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Restaurants</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<?php /*?><div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php echo base_url('admin/restaurant/add_restaurant');?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<thead>
										...
										<th width="51">Sl No.</th>
                                       	...
                                       	<th width="136">Restaurant Name</th>
					<th width="136">Local Name</th>
                                        <th width="362"><center>Options</center></th>                                        
                                        <th width="169"><center>Address</center></th>		    
					<th width="100"><center>Status</center></th>
				        <th width="81"><center>Action</center></th>
										</tr>
									</thead>
									<tbody>
										<?php 
                                        ...
                                        <td><?php echo ucfirst($restaurant['restaurant_sub_name']);?></td>


                                        <td><center><a href="<?php echo base_url(); ?>admin/category/manage_category/<?php echo $restaurant['id']; ?>">Manage Category</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/category_menu/manage_menu/<?php echo $restaurant['id']; ?>">Manage Menu</a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/cuisine/restaurant_cuisine/<?php echo $restaurant['id']; ?>">Manage Cuisine</a></center></td>
                                        
                                       <td><?php echo ucfirst($restaurant['address']);?></td>
                                       
                                                                                    
                                            <td><center><select class="m-wrap span4 status" id="<?php echo $restaurant['id'];?>" name="status" style="width:170px;<?php if($restaurant['approval_status']=='1'){?>color:#090;<?php } ?><?php if($restaurant['approval_status']=='0'){?>color:#F00;<?php } ?>">
											
											<option value="0" <?php if($restaurant['approval_status']=='0'){echo "selected"; }?> style="color:#F00; font-size:14px;">Pending Approval</option>
											<option value="1" <?php if($restaurant['approval_status']=='1'){echo "selected"; }?> style="color:#0C0; font-size:14px;">Approved</option>                                            
                                             
</select></center></td>


<td><center><a href="<?php echo base_url("admin/restaurant/edit_restaurant/".$restaurant['id']);?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i></a>&nbsp;&nbsp;

<a href="<?php echo base_url("admin/restaurant/delete_restaurant/id/".$restaurant['id']);?>" onClick="return confirm('Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>&nbsp;&nbsp;

<a href="<?php echo base_url("admin/restaurant/add_sub_restaurant/".$restaurant['id']);?>" onClick="return confirm('" style="text-decoration:none;"><i class="icon-large icon-plus" style="font-size:20px; color:#FF0000;"></i></a></center></td>
...
$(document).on('change','.status',function(){
 ...
 var status_data = $(this).val();
  var rest_id = $(this).attr('id'); 
	  ...
	  $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/restaurant/change_restaurant_status",
