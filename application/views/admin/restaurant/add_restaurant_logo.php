...
$restaurant_name = $this->restaurant_model->get_restaurant($owner_id);
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Add Restaurant Logo</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url('admin/restaurant_logo/add_restaurant_logo/'.$rest_id.'/id/'.$owner_id.''); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<input id="file" class="m-wrap span4" value="" type="file" name="file" required />
										</div>
									</div>
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
										<input id="file2" class="m-wrap span4" value="" type="file" name="file2" required/>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<textarea name="rest_desc" id="rest_desc" rows="4" class="m-wrap span4"></textarea>
										</div>
									</div>
