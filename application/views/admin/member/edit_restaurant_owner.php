					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit Restaurant Owner</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url("admin/member/edit_restaurant_owner/id/".$res['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="name" class="m-wrap span4" type="text" name="first_name" value="<?php echo $res['first_name'];?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">Last Name<span class="required">*</span></label>
										<div class="controls">
											<input id="name" class="m-wrap span4" type="text" name="last_name" value="<?php echo $res['last_name'];?>"/>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" name="email" id="email" value="<?php echo $res['email'];?>" />
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="password" class="m-wrap span4" name="password" id="password" value="<?php echo $res['password'];?>" />
										</div>
									</div>
                                   ...
                                   <div class="control-group">
										...
										<div class="controls">
                                            ...
                                            <?php if($res['owner_image']!=''){ ?>
                                            <img src="<?php echo base_url(); ?>image_gallery/restaurant_owner/<?php echo $res['owner_image'];?>" style="height:50px; width:50px;"/>
                                            <?php } ?>
                                            
                                            <input type="hidden" name="file_hidden" value="<?php echo $res['owner_image'];?>"/>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" name="phone" id="phone" value="<?php echo $res['phone'];?>" />
										</div>
									</div>
									...
									<!--<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4"  value="<?php echo $res['dob'];?>" name="dob" id="datepicker" />
										</div>
									</div>-->
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" name="restaurant_name" id="restaurant_name" value="<?php echo $res['restaurant_name'];?>" />
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input id="restaurant_phone" class="m-wrap span4" value="<?php echo $res['restaurant_phone'];?>" type="text" name="restaurant_phone"/>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input id="restaurant_address" class="m-wrap span4" value="<?php echo $res['restaurant_address'];?>" type="text" name="restaurant_address"/>
										</div>
									</div>
...
<option <?php if($res['country']==$country_all['id']){echo 'selected="selected"';}?> value="<?php echo $country_all['id'];?>"><?php echo ucfirst($country_all['countryname']);?></option>
<?php } ?>
	</select>
										</div>
									</div>
	...
	foreach ($state as $key => $pks) {
								...
								<option value='<?php echo $pks1['id'];?>' <?php if($pks1['id']==$res['city']){echo 'selected="selected"';}?> ><?php echo utf8_decode($pks1['countryname']);?></option>
								<?php
								}
								}
								?>
									...
									<!--<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" name="address" id="address" value="<?php echo $res['address'];?>" />
										</div>
									</div>-->
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" name="zip_code" id="zip_code" value="<?php echo $res['zip_code'];?>" />
										</div>
									</div>
                  ...
                  <!--<div class="control-group">
										...
										<div class="controls">
											<input type="file" class="m-wrap span4" name="resume" id="resume"/>
										</div>
									</div>-->
									<div class="control-group">
										...
										<div class="controls">
											...
											<option <?php if($res['status']==1){echo 'selected="selected"';}?> value="1">Active</option>
											<option <?php if($res['status']==0){echo 'selected="selected"';}?> value="0">Inactive</option>
											</select>
										</div>
									    </div> 
									<div class="form-actions">
										<!--<button type="submit" class="btn green" id="adcms">Submit</button>-->
                                                                                <input type="submit" name="submit" class="btn red" value="UPDATE MEMBER">
