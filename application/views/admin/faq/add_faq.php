...
<li><a href="<?php echo base_url('admin/faq/add'); ?>">Add Faq</a></li>
</ul>
...
<form action="<?php echo base_url('admin/faq/add'); ?>" method="post" enctype="multipart/form-data">
...
<label class="control-label">Question</label>
 <textarea class="m-wrap span8" name="question" id="question" style="height:100px;"></textarea>
 
 <label class="control-label">Answer</label>
 <textarea class="m-wrap span8" name="answer" id="answer" style="height:150px;"></textarea> 
