				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo base_url('admin/faq');?>">Manage Faq</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Faq</div>
								<div class="tools">
                  ...
                  <a href="<?php echo base_url('admin/faq/add'); ?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									foreach($faq as $allfaq){ ?>
										<tr >
                                        <td><?php echo $si ?></td>
											<td><?php if($allfaq['faq_category']==1){echo 'General'; }; if($allfaq['faq_category']==2){echo 'Ordering'; }; if($allfaq['faq_category']==3){echo 'Delivery'; }; if($allfaq['faq_category']==4){echo 'Payments'; }; if($allfaq['faq_category']==5){echo 'My Account'; }; ?></td>
                                            <td><?php if(strlen($allfaq['question'])>50){echo ucfirst(substr(strip_tags(stripslashes($allfaq['question'])),0,50)).".......";}else { echo ucfirst($allfaq['question']) ;} ?></td>
                                            <td><?php if(strlen($allfaq['answer'])>50){echo ucfirst(substr(strip_tags(stripslashes($allfaq['answer'])),0,50)).".......";}else { echo ucfirst($allfaq['answer']) ;} ?></td>
                                            											
					                        <td><center><a href="<?php echo base_url("admin/faq/view/$allfaq[faq_id]");?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url("admin/faq/edit/$allfaq[faq_id]");?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i></a></center></td>
