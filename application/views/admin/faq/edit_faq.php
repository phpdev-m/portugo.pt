...
<li><a href="<?php echo base_url('admin/faq'); ?>">Manage Faq</a>
...
<form action="<?php echo base_url('admin/faq/edit/'.$query['faq_id']); ?>" method="post" enctype="multipart/form-data">


<label class="control-label">Category</label>
<select name="category" id="category" class="m-wrap span8">

<option value="">Select Category</option>
<option value="1" <?php if($query['faq_category']==1){echo "selected"; }?>>General</option>
<option value="2" <?php if($query['faq_category']==2){echo "selected"; }?>>Ordering</option>
<option value="3" <?php if($query['faq_category']==3){echo "selected"; }?>>Delivery</option>
<option value="4" <?php if($query['faq_category']==4){echo "selected"; }?>>Payments</option>
<option value="5" <?php if($query['faq_category']==5){echo "selected"; }?>>My Account</option>
      
</select> 

<label class="control-label">Question</label>
 <textarea class="m-wrap span8" name="question" id="question" style="height:100px;"><?php echo stripslashes($query['question']); ?></textarea>
 
 <label class="control-label">Answer</label>
 <textarea class="m-wrap span8" name="answer" id="answer" style="height:150px;"><?php echo stripslashes($query['answer']); ?></textarea> 
...
<div id="myDiv"><?php if(isset($error) && $error!=''){?><br /><div class="error" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?=$error?></div><?php } ?></div> <br />
<div style="height: auto;" id="accordion1-1" class="accordion collapse">
<form action="<?php echo base_url('admin/faq/edit_portugoese/'.$query['faq_id']); ?>" method="post" enctype="multipart/form-data">

<label class="control-label">Category</label>
<select name="category" id="category" class="m-wrap span8">

<option value="">Select Category</option>
<option value="1" <?php if($query['faq_category']==1){echo "selected"; }?>>Geral</option>
<option value="2" <?php if($query['faq_category']==2){echo "selected"; }?>>Encomenda</option>
<option value="3" <?php if($query['faq_category']==3){echo "selected"; }?>>Delivery</option>
<option value="4" <?php if($query['faq_category']==4){echo "selected"; }?>>Pagamentos</option>
<option value="5" <?php if($query['faq_category']==5){echo "selected"; }?>>Minha conta</option>
      
</select> 

<label class="control-label">Question</label>
 <textarea class="m-wrap span8" name="question" id="question" style="height:100px;"><?php echo stripslashes($query['portugoese_question']); ?></textarea>
 
 <label class="control-label">Answer</label>
 <textarea class="m-wrap span8" name="answer" id="answer" style="height:150px;"><?php echo stripslashes($query['portugoese_answer']); ?></textarea> 
