					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Faq Detail</div>
						   ...
						   ?>
								<table class="table table-striped table-hover table-bordered" id="">
									<thead>
										<tr>
											<th>Sl No.</th> <td><?php echo $faq_detail['faq_id']; ?></td></tr>
										<tr>	<th>Category</th> <td><?php if($faq_detail['faq_category']==1){echo 'General'; }; if($faq_detail['faq_category']==2){echo 'Ordering'; }; if($faq_detail['faq_category']==3){echo 'Delivery'; }; if($faq_detail['faq_category']==4){echo 'Payments'; }; if($faq_detail['faq_category']==5){echo 'My Account'; }; ?></td></tr>
										<tr> <th valign="middle">Question</th>  <td><?php echo ucfirst(stripslashes($faq_detail['question'])); ?></td></tr>
                                        
                                        <tr> <th valign="middle">Answer</th>  <td><?php echo ucfirst(stripslashes($faq_detail['answer'])); ?></td></tr>
                                           <tr> <th>status</th> <td><?php if($faq_detail['status']==0){ echo "Inactive";} if($faq_detail['status']==1){echo "Active";} ?></td></tr>
