					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Transaction</div>
								<div class="tools">
                  ...
                  <a href="<?php echo base_url('admin/cms/add'); ?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									foreach($transaction as $alltransaction){ ?>
                                        ...
                                        <td><?php echo $si ?></td>
										<?php
										$user_details_mentee = $this->transaction_model->user_details_mentee($alltransaction['mentee_id']);
										$user_details_mentor = $this->transaction_model->user_details_mentor($alltransaction['mentor_id']);
										
										?>
											<td><?php echo ucfirst($user_details_mentee['first_name']); ?>&nbsp;<?php echo ucfirst($user_details_mentee['last_name']); ?></td>
                                            <td><?php echo ucfirst($user_details_mentor['first_name']); ?>&nbsp;<?php echo ucfirst($user_details_mentor['last_name']); ?></td>
											<td><?php echo '$'.$alltransaction['sub_total']; ?></td>
											<td><?php if($alltransaction['status']==0){echo "Inactive";} if($alltransaction['status']==1){echo "Active";} ?></td>
					                        <td><a href="<?php echo base_url("admin/transaction/view/$alltransaction[id]");?>">View</a></td>
