...
<li><a href="<?php echo base_url('admin/seo/tittle'); ?>">Manage Tittle</a>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Add Tittle</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                 <form action="<?php echo base_url('admin/seo/add_tittle'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                               ...
                               <div id="myDiv"><?php if(isset($error) && $error!=''){?><br /><div class="error" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?=$error?></div><?php } ?></div> <br />
									<div class="control-group">
										<label class="control-label">Tittle Name<span class="required">*</span></label>
										<div class="controls">
											<input id="name" class="m-wrap span4" type="text" value="<?php echo $this->input->post('tittle_name');?>" name="tittle_name"/>
										</div>
									</div>
                                    ...
                                    <input type="submit" name="submit" class="btn green" value="Add Tittle">
