				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/seo/tittle'); ?>">Manage Title</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Title</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<!--<div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php echo base_url('admin/seo/add_tittle');?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr>
										<td><?php echo $sn;?></td>
											<td><?php echo ucfirst($w['tittle_name']);?></td>
											
											<!--<td class="center">
		                                    <?php if($w['status']==0){ echo "Inactive";} if($w['status']==1){echo "Active";}?>
                                            </td>-->
											
											<td><center><a href="<?php echo base_url("admin/seo/edit_tittle/id/".$w['id']);?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i>
                                            </a>&nbsp;&nbsp;&nbsp;&nbsp;
											<!--<a href="<?php echo base_url("admin/seo/delete_tittle/id/".$w['id']);?>" onClick="return confirm('Are You Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="<?php echo base_url("admin/seo/view_tittle/id/".$w['id']);?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></center></i>
                                            </a>--></td>
										</tr>
									<?php $sn++;} ?>	
									</tbody>
