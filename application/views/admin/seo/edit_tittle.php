...
<li><a href="<?php echo base_url('admin/seo/tittle'); ?>">Manage Title</a>
<i class="icon-angle-right"></i>
</ul>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit Title</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url("admin/seo/edit_tittle/id/".$res['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label">Title Name<span class="required">*</span></label>
										<div class="controls">
											<input id="name" class="m-wrap span4" type="text" name="tittle_name" value="<?php echo $res['tittle_name'];?>"/>
										</div>
									</div>
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/seo/tittle'); ?>"><button class="btn green" value="CANCEL">CANCEL</button></a>
