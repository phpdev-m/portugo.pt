...
<li><a href="<?php echo base_url('admin/seo/logo'); ?>">Manage Logo</a>
<i class="icon-angle-right"></i>
</ul>
...
<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit Logo</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url("admin/seo/edit_logo/id/".$query['id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<!--<input id="name" type="file" value="<?php echo $this->input->post('file');?>" name="file"/>-->
  ...
  <tr>
	...
	<?php
	if($query['logo']!=''){?>
	<img src="<?php echo base_url();?>public/images/<?php echo $query['logo'];?>"  width="100" height="100" />
	<?php } ?>
	</div>
	<!--<div id="preview">
    ...
    <td valign="top"><div style="margin:0px 2px 0px 0px;">
  <label class="myLabel3" >
    <input type="file" onchange="readURL(this);" name="file" accept="image/*"/>
	<input type="hidden" name="file_hidden" value="<?php echo $query['logo'];?>"/>
    <span style="font-size:12px;"><?php echo $this->lang->line('Select File'); ?></span>
 </label>
 <p style="font-size:12px"><?php echo $this->lang->line('Under 5mb Please'); ?></p>
   </div></td>
  </tr>
</table>
                                    ...
                                    <input type="submit" name="submit" class="btn red" value="Update">
