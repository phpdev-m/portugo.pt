				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php echo base_url('admin/seo/logo'); ?>">Manage Lgo</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>View Logo</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="">
									...
									<thead>
										<tr><th>Sl No.</th> <td><?php echo $query['id'];?></td></tr>
										<tr><th>logo</th> <td><?php if($query['logo']!='' ){?>
	                                       <img src="<?php echo base_url(); ?>/public/images/<?php echo $query['logo'];?>"  width="120" height="100" />
	                                       <?php } ?></td></tr>
