					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Add Logo</div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                 <form action="<?php echo base_url('admin/seo/add_logo'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                               ...
                               <div id="myDiv"><?php if(isset($error) && $error!=''){?><br /><div class="error" style="margin:10px 0px;"><div id="close" style="float:right; cursor:pointer;">X</div><?=$error?></div><?php } ?></div> <br />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="file" type="file" value="<?php echo $this->input->post('file');?>" name="file"/>
										</div>
									</div>
                                    ...
                                    <button type="submit" name="submit" class="btn red">Add Logo <i class="icon-save"></i></button>
