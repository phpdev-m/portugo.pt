				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php if(!empty($rest_id)){echo base_url('admin/payment/manage_payment/'.$rest_id);}else{echo base_url('admin/payment/manage_payment');} ?>">Manage Payments</a>
								<i class="icon-angle-right"></i>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<form  action="<?=base_url()?>admin/payment/manage_payment" method="POST">	
								<div class="span3">
								     <div class="controls" >
								...
								<div class="span3"><button class="btn green" name="submit" value="submit">Search </button></div>
								</form>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<!--<td><center><a href="<?php if(!empty($rest_id)){echo base_url("admin/payment/payment_view/id/".$w['order_id']."/".$rest_id); }else{ echo base_url("admin/payment/payment_view/id/".$w['order_id']);} ?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>
                                        </a>
                                        </center></td>-->
										</tr>
									<?php $sn++;} ?>	
