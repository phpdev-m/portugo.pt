					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
                                                          <form action="<?php if(!empty($rest_id)){echo base_url('admin/category/add_category/'.$rest_id); }else{ echo base_url('admin/category/add_category');} ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-actions">
                                        ...
                                        <input type="submit" name="submit" class="btn green" value="ADD">&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php if(!empty($rest_id)){echo base_url('admin/category/manage_category/'.$rest_id);}else{echo base_url('admin/category/manage_category');} ?>"><button type="button" class="btn green" id="adcms">CANCEL</button></a>
