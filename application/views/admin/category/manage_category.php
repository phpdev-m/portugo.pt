				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?php if(!empty($rest_id)){echo base_url('admin/category/manage_category/'.$rest_id);}else {echo base_url('admin/category/manage_category');} ?>">Manage Category</a>
								<i class="icon-angle-right"></i>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Category</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
                  <a href="<?php if(!empty($rest_id)){echo base_url('admin/category/add_category/'.$rest_id); }else{ echo base_url('admin/category/add_category');} ?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<td><?php echo $sn;?></td>
					                      ...
					                      <td><?php echo date('d-m-Y',strtotime($category_all['create_date'])); ?></td> 
										 
                                         
											
										
											<td class="center">
		                                    <?php if($category_all['status']==0){ echo "Inactive";} if($category_all['status']==1){echo "Active";}?>
                                            </td>
											
                                            
                                            <td><center><a href="<?php if(!empty($rest_id)){echo base_url("admin/category/edit_category/id/".$category_all['id']."/".$rest_id); }else {echo base_url("admin/category/edit_category/id/".$category_all['id']);} ?>"><i class="icon-large icon-edit" style="font-size:20px;"></i>
</a>&nbsp;&nbsp;

											<a href="<?php if(!empty($rest_id)){echo base_url("admin/category/delete_category/id/".$category_all['id']."/".$rest_id);}else {echo base_url("admin/category/delete_category/id/".$category_all['id']);} ?>" onClick="return confirm('Sure you want to delete this?');"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
</center></td>
