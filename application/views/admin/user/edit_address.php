...
<li><a href="<?php echo base_url();?>admin/user/address/id/<?php echo $c_id; ?>">Manage Address  </a>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit Address </div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url();?>admin/user/edit_address/c_id/<?php echo $c_id; ?>/id/<?php echo $id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls" >
										     ...
										     <select name="customer_id" style="width:280px;" readonly="readonly">
												 ...
												 <option value="<?php echo $customers['user_id']; ?>"<?php if($customers['user_id']==$c_id) { echo "selected=selected"; } ?> ><?php echo $customers['first_name'].'&nbsp;'.$customers['last_name']; ?></option>
												 <?php } ?>
                                             </select>
									...
									<?php /*?><div class="control-group">
										...
										<div class="controls">
											<input id="address_tittle" class="m-wrap span4" value="<?php echo $address['address_tittle'];?>" type="text" name="address_tittle"/>
										</div>
									</div> <?php */?>                           
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['apartment'];?>" name="apartment" id="apartment" />
										</div>
									</div>
									 ...
									 <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" maxlength="13" value="<?php echo $address['address'];?>" name="address" id="address" />
										</div>
									</div>
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['city'];?>" name="city" id="city" />
										</div>
									</div>
                                    ...
                                    <!-- <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['state'];?>" name="state" id="state" />
										</div>
									</div>
									-->
									  ...
									  <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['zip_code'];?>" name="zip_code" id="zip_code" />
										</div>
									</div>
									  ...
									  <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['landmark'];?>" name="landmark" id="landmark" />
										</div>
									</div>
									 ...
									 <!--<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="m-wrap span4" value="<?php echo $address['landline'];?>" name="landline" id="landline" />
										</div>
									</div> -->
									  ...
									  <div class="control-group">
										...
										<div class="controls">
											<input type="radio" name="address_lavel" value="Home"<?php if($address['address_level']=='Home') {echo "checked"; }?>>&nbsp;Home &nbsp;&nbsp;
									        <input type="radio" name="address_lavel" value="Office" <?php if($address['address_level']=='Office') {echo "checked"; }?>>&nbsp;Office &nbsp;&nbsp;
                                            <input type="radio" name="address_lavel" value="Other" <?php if($address['address_level']=='Other') {echo "checked"; }?>>&nbsp;Other
										</div>
									</div> 
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<option <?php if($address['status']==1){echo 'selected="selected"';}?> value="1">Active</option>
											<option <?php if($address['status']==0){echo 'selected="selected"';}?> value="0">Inactive</option>
											</select>
										</div>
									    </div>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/user/address/id/'.$c_id);?>"><button type="button" class="btn green" id="adcms">CANCEL</button></a>
