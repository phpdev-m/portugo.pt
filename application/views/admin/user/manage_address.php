					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Addresses </div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
									<a href="<?php echo base_url();?>admin/user/add_address/id/<?php echo $id; ?>"/>
									
                  <!--<a href="<?php echo base_url('admin/user/add_address');?>">-->
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										$sn=1;
										foreach($address as $w){
										
										?>
										<tr>
										<td><?php echo $sn;?></td>
										<?php /*?><td><?php echo ucwords($w['address_tittle']);?></td> <?php */?>
										<td><?php 
										$customer = $this->user_model->get_customer($w['customer_id']);
						
										echo ucfirst($customer['first_name']);?>&nbsp;<?php echo ucfirst($customer['last_name']);?></td>
			                            
                                        <td class="center"><?php echo ucwords($w['apartment'].'&nbsp,'.$w['landmark'].'&nbsp,'.$w['address'].'&nbsp,'.$w['city'].'&nbsp,'.$w['zip_code']);?></td>
										<td class="center"><?php echo date('m-d-Y',strtotime($w['added_date']));?></td>
                                        <td class="center"><?php if($w['status']==0){ echo "Inactive";} if($w['status']==1){echo "Active";}?></td>
										
										
										
										<td><center><a href="<?php echo base_url();?>admin/user/edit_address/c_id/<?php echo $w['customer_id'];?>/id/<?php echo $w['id'];?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i>
                                        </a>
										&nbsp;&nbsp;
										<a href="<?php echo base_url();?>admin/user/delete_customer/c_id/<?php echo $w['customer_id'];?>/id/<?php echo $w['id'];?>" onClick="return confirm('Are You Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
                                        </center></td>
										</tr>
									<?php $sn++;} ?>	
									</tbody>
