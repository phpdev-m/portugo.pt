...
<li><a href="<?php echo base_url('admin/user'); ?>">Manage User  </a>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-body form">
                                                          <form action="<?php echo base_url('admin/user/add_user'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="password" class="m-wrap span4" value="<?php echo $this->input->post('cpassword');?>" name="cpassword" id="cpassword" />
										</div>
									</div>
