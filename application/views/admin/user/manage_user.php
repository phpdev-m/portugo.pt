                  ...
                  <a href="<?php echo base_url('admin/user/add_user');?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
                                        ...
                                        <td class="center"><?php echo $w['phone'];?></td>
										<td class="center"><?php
										echo date('d-m-Y',strtotime($w['created_date']));?></td>
                                        <td class="center"><?php if($w['status']==0){ echo "Inactive";} if($w['status']==1){echo "Active";}?></td>
										
										<td><center><a href="<?php echo base_url("admin/user/address/id/".$w['user_id']);?>" >Addresses
                                        </a>&nbsp;&nbsp;<a href="<?php echo base_url("admin/user/order/id/".$w['user_id']);?>" >Orders
                                        <?php //$order = $this->user_model->get_user_order($w['user_id']);
										//print_r($order);
										 //echo $order;
										?>
										</a>
										...
										<td><center><a href="<?php echo base_url("admin/user/user_edit/id/".$w['user_id']);?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i>
                                        </a>&nbsp;&nbsp;<a href="<?php echo base_url("admin/user/user_view/id/".$w['user_id']);?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>
                                        </a>
										&nbsp;&nbsp;
										<a href="<?php echo base_url("admin/user/delete_user/id/".$w['user_id']);?>" onClick="return confirm('Are You Sure you want to delete this?');" style="text-decoration:none;"><i class="icon-large icon-trash" style="font-size:20px; color:#FF0000;"></i></a>
                                        </center></td>
										</tr>
									<?php $sn++;} ?>	
									</tbody>
