						...
						<div class="portlet box red">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="">
									...
									<thead>
										<tr>
											<th>Sl No.</th> <td><?php echo $query['user_id'];?></td></tr>
										    <tr><th>User Name</th> <td><?php echo ucfirst($query['first_name']);?> &nbsp;<?php echo ucfirst($query['last_name']);?></td></tr>
										    <tr> <th>Email Id</th> <td><?php echo $query['email'];?></td></tr>
											<tr> <th>Phone Number</th> <td><?php echo $query['phone'];?></td></tr>
                                            <tr> <th>Mobile Number</th> <td><?php echo $query['mobile'];?></td></tr>
