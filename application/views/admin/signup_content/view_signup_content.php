				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo base_url('admin/signup_content');?>">Manage Signup Content</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Signup Content Detail</div>
						   ...
						   ?>
								<table class="table table-striped table-hover table-bordered" id="">
									<thead>
										<tr>
											<th>Sl No.</th> <td><?php echo $signup_content_detail['signup_content_id']; ?></td></tr>
										<tr>	<th>Content Title</th> <td><?php echo ucwords($signup_content_detail['content_title']); ?></td></tr>
										<tr> <th valign="middle">Content Description</th>  <td><?php echo ucfirst(stripslashes($signup_content_detail['content_desc'])); ?></td></tr>
                                        
                                      	<tr> <th>Content Image</th> <?php if($signup_content_detail['content_image']!=''){ ?>
                                            <td><img src="<?php echo base_url(); ?>image_gallery/content_image/<?php echo $signup_content_detail['content_image'];?>" style="height:50px; width:50px;"/>
                                            <?php } ?></td></tr>
                                           
                                           <tr> <th>status</th> <td><?php if($signup_content_detail['status']==0){ echo "Inactive";} if($signup_content_detail['status']==1){echo "Active";} ?></td></tr>
