				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<?php echo base_url('admin/cms');?>">Manage Signup Content</a></li>
						</ul>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Manage Signup Content</div>
								<div class="tools">
                  ...
                  <a href="<?php //echo base_url('admin/cms/add'); ?>">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<?php
                                    $si=1;
									foreach($signup_content as $allcontent){ ?>
										<tr >
                                        <td><?php echo $si ?></td>
											<td><?php echo ucfirst($allcontent['content_title']); ?></td>
                                            <td><?php if(strlen($allcontent['content_desc'])>50){echo ucfirst(substr(strip_tags(stripslashes($allcontent['content_desc'])),0,50)).".......";}else { echo ucfirst($allcontent['content_desc']) ;} ?></td>											
					                        <td><center><a href="<?php echo base_url("admin/signup_content/view/$allcontent[signup_content_id]");?>" style="text-decoration:none;"><i class="icon-large icon-eye-open" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url("admin/signup_content/edit/$allcontent[signup_content_id]");?>" style="text-decoration:none;"><i class="icon-large icon-edit" style="font-size:20px;"></i></a></center></td>
